...
then enter the file name with extention which you would like to convert.
...
6: If the PDF has multiple pages, it will conver each page as a single image & extract the text of first page which is converted as image.
7: If you would like to take the text of any other page apart from first page then you may need to specify it in the code.
8: Attaching some SS of the output for the refrence.
